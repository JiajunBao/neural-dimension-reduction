...
def eval_with_query(base_loader, query_loader, model, device):
    ...
    base_neighbor_distance, base_neighbor_index = index.search(embedded_base, base_loader.dataset.k)  # actual search
    query_neighbor_distance, query_neighbor_index = index.search(embedded_queries, query_loader.dataset.k)  # actual search
