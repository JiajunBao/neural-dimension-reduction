...
if __name__ == '__main__':
    kwargs_list1 = [{'input-size':90000,'test-size':1000,'hidden-dims':[500, 100, 20, 20, 20],'output-dimension':10,'lambda':1,'epochs':0,
                    'to_plot':True,'learning_rate':0.01,'momentum':.9,'data':'artificial3_10_200','filename_prefix':'500_100_3*20_tmp'}
                    ]
    main(kwargs_list1)

    # kwargs_list1 = [{'input-size':90000,'test-size':1000,'hidden-dims':[500, 100, 20, 20, 20, 20, 20],'output-dimension':10,'lambda':1,'epochs':20,
    #                 'to_plot':True,'learning_rate':0.01,'momentum':.9,'data':'artificial3_10_200','filename_prefix':'500_100_5*20'}
    #                 ]
    # main(kwargs_list1)
